...
export function ShareButton({ productName, productSlug, price }: ShareButtonProps) {
  ...
  const shareData = {
    title: productName,
    text: `Cek ${productName} di Moon Fleurs! 🌸`,
    url,
  };
